    ...
    <Sidebar collapsible="icon" variant="inset">
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton
              ...
              className="h-auto items-start gap-3 rounded-2xl px-3 py-3 hover:bg-sidebar-accent/80"
            >
              <div className="flex size-11 items-center justify-center rounded-2xl bg-sidebar-primary text-sidebar-primary-foreground shadow-[0_20px_40px_rgba(8,145,178,0.32)]">
      ...
      <SidebarContent className="px-3 py-4">
        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <div className="surface-panel-dark space-y-5 p-4 text-sm">
              ...
              <div className="space-y-2 text-xs text-sidebar-foreground/70">
                <div className="flex items-center justify-between">
                  <span>Status</span>
                  <span className="font-medium text-sidebar-foreground">Connected</span>
                </div>
                <div className="flex items-center justify-between">
                  <span>API</span>
